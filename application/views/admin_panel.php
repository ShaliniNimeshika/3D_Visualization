            ...
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="scroll-sidebar" style="overflow: hidden; width: auto; height: 100%;">
                ...
                <nav class="sidebar-nav active">
                    <ul id="sidebarnav" class="in">
                        ...
                        <li class="active"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                    ...
                    <!-- <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="extra-area-chart" style="position: relative; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                                    <div class="morris-hover morris-default-style" style="left: 0px; top: 153px;">
                                        <div class="morris-hover-row-label">2001</div>
                                        <div class="morris-hover-point" style="color: #26DAD2">
                                              iphone:
                                              0
                                        </div>
                                        <div class="morris-hover-point" style="color: #fc6180">
                                              imac:
                                              0
                                        </div>
                                        <div class="morris-hover-point" style="color: #62d1f3">
                                              ibook:
                                              90
                                        </div>
                                        <div class="morris-hover-point" style="color: #ffb64d">
                                              samsung:
                                              0
                                        </div>
                                        <div class="morris-hover-point" style="color: #4680ff">
                                              android:
                                              0
                                        </div>
                                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="<?php echo base_url();?>assests/admin_panel/4(1).jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="<?php echo base_url();?>assests/admin_panel/2(1).jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="<?php echo base_url();?>assests/admin_panel/3(1).jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
