                            ...
                            <center>
                                ...
                                <div class="card-body">
                                    <form action="<?php echo base_url();?>index.php/Admin/add_category" method="POST" id="regform">
                                        ...
                                        <input type="text" name="catname" placeholder="Category Name"/><br><br><br><br>
                                        <button type="submit" value="new_category">Add Category</button>
                                    ...
                                    <form action="<?php echo base_url();?>index.php/Admin/new_item" method="POST" id="regform">
                                        ...
                                        <select name="catname"/>
                                            ...
                                            <?php
                                                ...
                                                echo "<option value='" . $row[0] ."'>" . $row->catname."</option>";
                                                }
                                            ?>
                                        </select>
                                        <br><br>
                                        ...
                                        <button type="submit" value="new_register">Add Item</button>
