...
<html>
<head>
	<title>INOAC | New Arrivals</title>
	...
	<!-- Bootstrap Core CSS -->
	<link href="<?php echo base_url();?>assests/styles/panel_css/bootstrap.min.css" rel='stylesheet' type='text/css' />
	<!-- Custom CSS -->
	<link href="<?php echo base_url();?>assests/styles/panel_css/style.css" rel='stylesheet' type='text/css' />
	<!-- Graph CSS -->
	<link href="<?php echo base_url();?>assests/styles/panel_css/font-awesome.css" rel="stylesheet"> 
	<!-- jQuery -->
	<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
	<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
	<!-- lined-icons -->
	<link rel="stylesheet" href="<?php echo base_url();?>assests/styles/panel_css/icon-font.min.css" type='text/css' />
	<script src="<?php echo base_url();?>assests/js/panel_js/amcharts.js"></script>	
	<script src="<?php echo base_url();?>assests/js/panel_js/serial.js"></script>	
	<script src="<?php echo base_url();?>assests/js/panel_js/light.js"></script>	
	<!-- //lined-icons -->
	<script src="<?php echo base_url();?>assests/js/panel_js/jquery-1.10.2.min.js"></script>
	   <!--pie-chart--->
	<script src="<?php echo base_url();?>assests/js/panel_js/pie-chart.js" type="text/javascript"></script>
    ...
    <!--/content-inner-->
			...
			<!-- top_bg -->
				...
				<div class="header_bg">						
					<div class="header">
						<div class="head-t">
							<div class="logo">
								<a href="<?php echo base_url();?>index.php/User/load_home"><img src="<?php echo base_url();?>assests/images/panel_images/logo.png" class="img-responsive" alt=""> </a>
							</div>
										<!-- start header_right -->
				...
				<div class="content">
					...
					<div class="col-md-5 skil">
						<div class="content-top-1">
							...
							<div class="col-md-6 top-content1">	   
								<div id="demo-pie-1" class="pie-title-center" data-percent="25"> <span class="pie-value">20%</span> </div>
							</div>
						...
						<div class="content-top-1">
							...
							<div class="col-md-6 top-content1">	   
								<div id="demo-pie-2" class="pie-title-center" data-percent="50"> <span class="pie-value">79%</span> </div>
							</div>
							<div class="clearfix"> </div>
						</div>
						...
						<div class="content-top-1">
							...
							<div class="col-md-6 top-content1">	   
								<div id="demo-pie-3" class="pie-title-center" data-percent="75"> <span class="pie-value">30%</span> </div>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					...
					<div class="col-md-7 mid-content-top">
						<div class="middle-content">
							<h3>Latest Products
									...
									<div id="owl-demo" class="owl-carousel text-center">
										<div class="item">
											<img class="lazyOwl img-responsive" data-src="<?php echo base_url();?>assests/images/panel_images/na.jpg" alt="name">
										</div>
										<div class="item">
											<img class="lazyOwl img-responsive" data-src="<?php echo base_url();?>assests/images/panel_images/na1.jpg" alt="name">
										</div>
										<div class="item">
											<img class="lazyOwl img-responsive" data-src="<?php echo base_url();?>assests/images/panel_images/na2.jpg" alt="name">
										</div>
										<div class="item">
											<img class="lazyOwl img-responsive" data-src="<?php echo base_url();?>assests/images/panel_images/na.jpg" alt="name">
										</div>
						...
						<link href="<?php echo base_url();?>assests/styles/panel_css/owl.carousel.css" rel="stylesheet">
						<script src="<?php echo base_url();?>assests/js/panel_js/owl.carousel.js"></script>
						<script>
							$(document).ready(function() {
					...
					<div class="content-top">
						<div class="col-md-6 content-top-lft">
							<div class="panel panel-widget">
								<div class="panel-title">Real Time Updates</div>
								<div class="panel-body">
				...
				<!--graph-->
							<!--<link rel="stylesheet" href="<?php echo base_url();?>assests/styles/panel_css/graph.css">-->
				<!--//graph-->
							<!--<script src="<?php echo base_url();?>assests/js/panel_js/jquery.flot.js"></script>
							<script>
								$(document).ready(function () {
		...
		<!--area-->					
				<!--<div class="area">
					<div class="col-md-6 chrt-two area">
						...
						<script src="<?php echo base_url();?>assests/js/panel_js/Chart.js"></script>
					</div>
					...
					<div class="fo-top-di">
						...
						<div class="footer">
							...
							<div class="clearfix"> </div>
							<p>©2018 All Rights Reserverd by <a href="#">INOVAC Fashionline</a></p>
						</div>
					</div>
				</div>
			<!--content-->
		...
		<div class="sidebar-menu">
			...
			<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                <div class="menu">
					<ul id="menu" >
						<li><a href="<?php echo base_url();?>index.php/User/load_home"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
						<li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> New Arrivals</span> <span class="fa fa-angle-right" style="float: right"></span></a>
							<ul id="menu-academico-sub" >
								<li id="menu-academico-avaliacoes" ><a href="#">Women</a></li>
								<li id="menu-academico-avaliacoes" ><a href="#">Men</a></li>
							</ul>
						</li>
						
						<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>Womens' Collection</span></a></li>
						<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>Mens' Collection</span></a></li>
						<li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>My Profile</span> <span class="fa fa-angle-right" style="float: right"></span></a>
							<ul id="menu-academico-sub" >
								<li id="menu-academico-avaliacoes" ><a href="#">Profile</a></li>
								<li id="menu-academico-avaliacoes" ><a href="#">My Cart</a></li>
								<li id="menu-academico-avaliacoes" ><a href="#">Order History</a></li>
							</ul>
						</li>
						
						<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>Discussion Forum</span></a></li>		
					</ul>
				</div>
			</div>
...
<!--js -->
		<script src="<?php echo base_url();?>assests/js/panel_js/jquery.nicescroll.js"></script>
		<script src="<?php echo base_url();?>assests/js/panel_js/scripts.js"></script>
<!-- Bootstrap Core JavaScript -->
   		<script src="<?php echo base_url();?>assests/js/panel_js/bootstrap.min.js"></script>
   <!-- /Bootstrap Core JavaScript -->
   <!-- real-time -->
		<script language="javascript" type="text/javascript" src="<?php echo base_url();?>assests/js/panel_js/jquery.flot.js"></script>
		<script type="text/javascript">
...
<!-- /real-time -->
		<script src="<?php echo base_url();?>assests/js/panel_js/jquery.fn.gantt.js"></script>
    	<script>
		...
		<script src="<?php echo base_url();?>assests/js/panel_js/menu_jquery.js"></script>
</body>
