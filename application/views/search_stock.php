            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Search Stock</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                                        ...
                                        <tbody>
                                            <?php  
                                                ...
                                                <tr>  
                                                    ...
                                                    <td><?php echo $row->avbqty;?></td> 
                                                    <td><?php echo $row->color;?></td> 
                                                    <td><span class="badge badge-success"><a href="#"><font color="black">Update Info</font></a></span></td>
                                                </tr>  
                                            <?php } ?>
                                        </tbody>
                                    </table>
